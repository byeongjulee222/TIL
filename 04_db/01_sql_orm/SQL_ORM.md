...
2. user 레코드 생성
   ...
   ```python
   # orm
   user = User(101, '정우', '신', 30, '대전', '010-1234-5667', 100)
   user.save()
   ```

   ```sql
   -- sql
   INSERT INTO users_user VALUES(101, '정우', '신', 30, '대전', '010-1234-5667', 100);
   ```
...
2. 잔액이 적은 사람순으로 10명
   ...
   ```
      ...
      ```sql
   -- sql
   SELECT * FROM users_user ORDER BY age (ASC, 생략가능) LIMIT 10;
      ```
